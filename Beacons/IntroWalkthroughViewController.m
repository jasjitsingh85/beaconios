...
@property (strong, nonatomic) PhoneView *phoneView01;
...
- (void)viewDidLoad
{
    ...
    NSArray *backgroundImageNames = @[@"firstGradientBackground", @"secondGradientBackground", @"thirdGradientBackground", @"fourthGradientBackground", @"fifthGradientBackground"];
...
//    [self.view addSubview:self.drinkView];
    ...
    NSString *line01 = @"Get the best prices on drinks";
    NSString *line02 = @" at the best bars in town";
    NSMutableAttributedString *_attributedString = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@\n%@", line01, line02]];
    [_attributedString setAttributes:@{NSFontAttributeName : [ThemeManager regularFontOfSize:19]} range:[_attributedString.string rangeOfString:line01]];
    [_attributedString setAttributes:@{NSFontAttributeName : [ThemeManager regularFontOfSize:19]} range:[_attributedString.string rangeOfString:line02]];
    self.phoneView01 = [[PhoneView alloc] initWithImage:[UIImage imageNamed:@"iphoneWalkthrough1"] captionString:_attributedString];
    [self.phoneView01 hideOffScreen];
    [self.view addSubview:self.phoneView01];
    
    NSString *line1 = @"We partner with venues so you";
    NSString *line2 = @"can buy drinks through the app";
    NSMutableAttributedString *attributedString = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"%@\n%@", line1, line2]];
    [attributedString setAttributes:@{NSFontAttributeName : [ThemeManager regularFontOfSize:19]} range:[attributedString.string rangeOfString:line1]];
    [attributedString setAttributes:@{NSFontAttributeName : [ThemeManager regularFontOfSize:19]} range:[attributedString.string rangeOfString:line2]];
    self.phoneView1 = [[PhoneView alloc] initWithImage:[UIImage imageNamed:@"iphoneWalkthrough2"] captionString:attributedString];
    [self.phoneView1 hideOffScreen];
    [self.view addSubview:self.phoneView1];
    
    NSString *view2Line1 = @"Earn free drinks when you text";
    NSString *view2Line2 = @"friends to meet through Hotspot";
    ...
    [attributedString2 setAttributes:@{NSFontAttributeName : [ThemeManager regularFontOfSize:19]} range:[attributedString2.string rangeOfString:view2Line1]];
    [attributedString2 setAttributes:@{NSFontAttributeName : [ThemeManager regularFontOfSize:19]} range:[attributedString2.string rangeOfString:view2Line2]];
    self.phoneView2 = [[PhoneView alloc] initWithImage:[UIImage imageNamed:@"iphoneWalkthrough3"] captionString:attributedString2];
    [self.phoneView2 hideOffScreen];
    [self.view addSubview:self.phoneView2];
    
    NSString *view3Line1 = @"Show vouchers to your server";
    NSString *view3Line2 = @"to redeem discounted drinks";
    ...
    [attributedString3 setAttributes:@{NSFontAttributeName : [ThemeManager regularFontOfSize:19]} range:[attributedString3.string rangeOfString:view3Line1]];
    [attributedString3 setAttributes:@{NSFontAttributeName : [ThemeManager regularFontOfSize:19]} range:[attributedString3.string rangeOfString:view3Line2]];
    self.phoneView3 = [[PhoneView alloc] initWithImage:[UIImage imageNamed:@"iphoneWalkthrough4"] captionString:attributedString3];
    [self.phoneView3 hideOffScreen];
    [self.view addSubview:self.phoneView3];
    
    NSString *view4Line1 = @"Search the largest and most";
    NSString *view4Line2 = @"up-to-date list of happy hours";
    ...
    [attributedString4 setAttributes:@{NSFontAttributeName : [ThemeManager regularFontOfSize:19]} range:[attributedString4.string rangeOfString:view4Line1]];
    [attributedString4 setAttributes:@{NSFontAttributeName : [ThemeManager regularFontOfSize:19]} range:[attributedString4.string rangeOfString:view4Line2]];
    self.phoneView4 = [[PhoneView alloc] initWithImage:[UIImage imageNamed:@"iphoneWalkthroughLastSlide"] captionString:attributedString4];
    ...
    self.registerButton.backgroundColor = [[ThemeManager sharedTheme] lightBlueColor];
    //self.registerButton.layer.cornerRadius = 4;
    [self.registerButton setTitle:@"GOT IT - LETS GO!" forState:UIControlStateNormal];
    [self.registerButton setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    self.registerButton.titleLabel.font = [ThemeManager boldFontOfSize:16];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    jadispatch_after_delay(0.5, dispatch_get_main_queue(), ^{
        self.currentPageView = self.phoneView01;
        [self.phoneView01 animateInFromRight];
    });
}
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    NSArray *pageViews = @[self.phoneView01, self.phoneView1, self.phoneView2, self.phoneView3, self.phoneView4];
...
- (id)initWithImage:(UIImage *)image captionString:(NSAttributedString *)captionString
{
    ...
    phoneFrame.size.width *= 1;
    phoneFrame.size.height *= 1;
    phoneFrame.origin.x = (self.width - phoneFrame.size.width)/2.0;
    phoneFrame.origin.y = 140;
    self.phoneView.frame = phoneFrame;
    [self addSubview:self.phoneView];
    
    self.captionLabel = [[UILabel alloc] init];
    CGRect captionFrame = CGRectZero;
    captionFrame.size = CGSizeMake(self.frame.size.width - 25, 135);
    captionFrame.origin.x = 0.5*(self.frame.size.width - captionFrame.size.width);
    captionFrame.origin.y = 25;
    self.captionLabel.frame = captionFrame;
