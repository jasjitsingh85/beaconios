...
@interface FindFriendsPopupView()
...
@implementation FindFriendsPopupView
//@synthesize delegate;
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    UIImageView *drinkIcon = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"friends"]];
    ...
    callHeader.y = 195;
    callHeader.text = @"To find the most friends on Hotspot and to invite them to your check-ins, we highly recommend linking facebook, and syncing contacts.";
    ...
    self.syncContactsButton.frame=CGRectMake(0,315,180,25);
         ...
         handler:^(FBSDKLoginManagerLoginResult *result, NSError *error) {
             ...
             if (error) {
                 ...
                 [[APIClient sharedClient] postFacebookToken:result.token.tokenString success:^(AFHTTPRequestOperation *operation, id responseObject) {
                     ...
                     [[NSNotificationCenter defaultCenter] postNotificationName:kRefreshManageFriends object:self];
                     [self changeFacebookButtonToCompletedState];
